...
class AutoUpdateClient
{
    ...
    static async Task Main()
    {
        ...
        if (!exeDir.Equals(ClientInstallDir, StringComparison.OrdinalIgnoreCase))
        {
            ...
            ZipFile.ExtractToDirectory(clientZip, ClientInstallDir, true);
    ...
    )
    {
        ...
        // 解压到软件目录
        ZipFile.ExtractToDirectory(zipPath, mainDir, overwriteFiles: true);
        ...
        ZipFile.ExtractToDirectory(updaterZip, updaterDir, overwriteFiles: true);
